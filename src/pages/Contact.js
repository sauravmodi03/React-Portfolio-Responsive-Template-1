                    ...
                    <div className="contact-info-wrapper">
                        ...
                        <article className='info-article'>
                            <div className="contact-info slide-right">
                                ...
                                <div className='info-val'>Chicago, Illinoi - 60616, USA</div>
                            </div>
                            <div className="contact-info slide-right">
                                <div><img src={this.props.darkTheme ? mailblackL : mailblack} alt='' /></div>
                                <div className='info-val'>test@gmail.com</div>
                            </div>
                            <div className="contact-info slide-right">
                                <div><img src={this.props.darkTheme ? wwwL : www} alt='' /></div>
                                <a href="https://www.yourwebsite.com" className='info-val'>https://www.yourwebsite.com</a>
                            </div>
                            <div className="contact-info slide-right">
                                <div><img src={this.props.darkTheme ? phoneblackL : phoneblack} alt='' /></div>
                                <div className='info-val'>+1 234 568 7890</div>
                            </div>
                        </article>
                    </div>
                </div>
