        ...
        <footer>
          <div className='foot-container'>
            <div className='foo-sec s-1'>
              ...
              <span>I would be happy to discuss any project ideas you have in mind.
                Let's collaborate and explore the possibilities!</span>
            ...
            <div className="foo-sec s-2">
              ...
              <article className='foo-contact'>
                <div className="foo-c-w">
                  ...
                  <div className='info-val'>Chicago, Illinois - USA</div>
                </div>
                <div className="foo-c-w">
                  <img src={darkTheme ? mailblackL : mailblack} alt='' />
                  <div className='info-val'>youremail@gmail.com</div>
                </div>
                <div className="foo-c-w">
                  <img src={darkTheme ? wwwL : www} alt='' />
                  <div className='info-val'>https://www.yourwebsite.co.in</div>
                </div>
                <div className="foo-c-w">
                  <img src={darkTheme ? phoneblackL : phoneblack} alt='' />
                  <div className='info-val'>+1 234 567 8901</div>
                </div>
              </article>
            </div>
              ...
              <span>
                <BrowserRouter>
                  <nav id="foot-links-wrap" className='foot-links-wrap'>
                    <RouterLink className='scale' to="#" target="_blank"><img alt="Linked logo" src={darkTheme ? linkedinL : linkedin} /></RouterLink>
                    <RouterLink className='scale' to="#" target="_blank"><img alt="Git logo" src={darkTheme ? gitL : git} /></RouterLink>
                    <RouterLink className='scale' to="#" target="_blank"><img alt="Insta logo" src={darkTheme ? instaL : insta} /></RouterLink>
                    <RouterLink className='scale' to="#" target="_blank"><img alt="Twitter logo" src={darkTheme ? twitterL : twitter} /></RouterLink>
                  </nav>
                </BrowserRouter>
              </span>
              <span className='copyright'>
                <span> © 2023 by Lorem Ipsum. All rights reserved.</span>
              </span>
            </div>
          </div>
        </footer>
